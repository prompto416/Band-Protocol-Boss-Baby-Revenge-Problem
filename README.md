...
## There are only two cases to set your eyes on with the 2nd case being a bit tricky but overall it's a very easy one pointer problem. Also I have exceptions for invalid input included as well. 
